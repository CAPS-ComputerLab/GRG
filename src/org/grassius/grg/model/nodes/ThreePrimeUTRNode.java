...
public class ThreePrimeUTRNode extends BasicEntity{
    ...
    public ThreePrimeUTRNode(Node n){
        super(n);
    }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof ThreePrimeUTRNode){
            ThreePrimeUTRNode other = (ThreePrimeUTRNode) obj;
    ...
    public ExonNode getExon() {
        ExonNode exon = null;
        Relationship rel = node.getSingleRelationship(new ExonThreePrimeUTRRel(null), Direction.INCOMING);
        if (rel != null) {
