...
import org.grassius.grg.model.relationships.ExonGRGCDSRel;
 ...
 */
public class GRGCDSNode extends BasicEntity{

    public static final String NODE_TYPE = GRGCDSNode.class.getCanonicalName();
    public static final String GRGCDS_ID_INDEX = "grg_cds_id_index";
    ...
    public boolean equals(Object obj) {
        if(obj instanceof GRGCDSNode){
            GRGCDSNode other = (GRGCDSNode) obj;
    ...
    public ChromosomeNode getChromosome() {
        ...
        Relationship rel = node.getSingleRelationship(new ExonGRGCDSRel(null), Direction.OUTGOING);
        if (rel != null) {
